...
def main(args):
    ...
    pairs_paths = pairs_paths[0:1028]
    pairs_dists = pairs_dists[0:1028]
    ...
    with tf.Graph().as_default():
        ...
        for _ in range(nrof_preprocess_threads):
            ...
            for filename in tf.unstack(filenames):
                ...
                lidarscan = tf.reshape(lidarscan, [3, 400*400])
                ...
                # reshape the normalized lidarscan to (400, 400, 3) for model_cnn.py
                height = lidarscan[0]
                reflection = lidarscan[1]
                density = lidarscan[2]
                lidarscan = tf.reshape(tf.stack([height, reflection, density], axis=1), (400, 400, 3))
        ...
        lidarscan_batch, labels_batch, dist_batch = tf.train.batch_join(
            ...
            shapes=[(400, 400, 3), (), ()], enqueue_many=True,
...
def parse_arguments(argv):
    ...
    parser.add_argument('--logs_base_dir', type=str,
                        ...
                        default='D:/User/Sisi_Tao/Masterarbeit/logs/evaluation_on_map_bev')
    parser.add_argument('--gpu_memory_fraction', type=float,
                        help='Upper bound on the amount of GPU memory that will be used by the process.', default=1.0)
    parser.add_argument('--pretrained_model', type=str,
                        help='Load a pretrained model before training starts.',
                        default='../../models/train_distance_bev/20190218-134455/model-20190218-134455.ckpt-12440')
    # default='../../models/train_distance_bev/20190207-152345/model-20190207-152345.ckpt-40000'
