...
in_dir = 'C:/Users/Stadtpilot/Desktop/datasets/2017_01_27_Ring_raw_without_video'
out_dir = 'C:/Users/Stadtpilot/Desktop/datasets/bev4'
...
for lidar_file in lidar_list[8259:-1]:
    ...
    for h in range(side_cells):
        for w in range(side_cells):
            ...
            lidar_data_new[2][h][w] = np.sqrt((h * 0.25 - 200 * 0.25) ** 2 + (w * 0.25 - 200 * 0.25) ** 2)
